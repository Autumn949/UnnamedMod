...
import dev.unnamed.vnv.data.models.stategen.IBlockStateGen;
...
public class VnvStateModelProvider implements IDataProvider {
    ...
    public VnvStateModelProvider(DataGenerator datagen) {
