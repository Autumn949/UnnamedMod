...
import com.example.examplemod.data.models.stategen.IBlockStateGen;
...
public class ModStateModelProvider implements IDataProvider {
    ...
    public ModStateModelProvider(DataGenerator datagen) {
