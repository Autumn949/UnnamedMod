...
import com.example.examplemod.init.Registration;
...
public class UnnamedMod
{
    ...
    private void enqueueIMC(final InterModEnqueueEvent event)
    {
        ...
        InterModComms.sendTo("examplemod", "helloworld", () -> { LOGGER.info("IMC comm examplemod"); return "Hello world";});
    }
