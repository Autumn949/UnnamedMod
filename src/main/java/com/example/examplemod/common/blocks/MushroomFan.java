...
public class MushroomFan extends Block {
    public MushroomFan(Properties p_i48440_1_) {
        super(p_i48440_1_);
    }
    ...
    public boolean isValidPosition(BlockState p_196260_1_, IWorldReader p_196260_2_, BlockPos p_196260_3_) {
        ...
        if((!(blockn==Blocks.AIR))||(!(blocks==Blocks.AIR))||(!(blocke==Blocks.AIR))||(!(blockw==Blocks.AIR))){
            return true;
        }
        return false;
    }
